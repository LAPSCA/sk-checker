######################################
#      LAPSCA TEAM 2023©             #
# Use The Code in Good Thing         #
# Author : By Mika & X & niuoten😎   #
# Github : https://githb.com/LAPSCA  #
######################################
import os
...
{}|____/|_|\_\     \____|_| |_|\___|\___|_|\_\___|_| {}> LAPSCA TEAM '''.format(brblue, white, brblue, white)
    print(my_banner)
